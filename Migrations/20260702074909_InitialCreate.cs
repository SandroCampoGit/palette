        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryMode = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtistName = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    ...
                    SoundCloud = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
                    YouTube = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
                    OpenToCollab = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CollabRequests_ArtistProfiles_ToArtistProfileId",
                        column: x => x.ToArtistProfileId,
                        principalTable: "ArtistProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CollabRequests_AspNetUsers_FromUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PortfolioImages_ArtistProfiles_ArtistProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollabRequests_FromUserId",
                table: "CollabRequests",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CollabRequests_ToArtistProfileId_Status",
                table: "CollabRequests",
                columns: new[] { "ToArtistProfileId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_PortfolioImages_ArtistProfileId",
